...
import { i as __exportAll, n as createCsrfMiddleware } from "./server-1hXjwGMJ.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DaaRAhGr.mjs");
...
var manifest = { "d617a46fdf585928d24717a1a82d4f39df931f582c18829da984df70c8f99096": {
	...
	importer: () => import("./discovery.functions-DAME6_Kv.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BCJVnwsE.mjs").then((n) => n.t),
