...
import { n as createMiddleware, r as __exportAll } from "./server-CplBqpah.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DZEHFQf_.mjs");
...
var manifest = { "d617a46fdf585928d24717a1a82d4f39df931f582c18829da984df70c8f99096": {
	...
	importer: () => import("./discovery.functions-Dh2MN00i.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-I5TLBfZI.mjs").then((n) => n.t),
		import("./start-Cf58uNB9.mjs"),
